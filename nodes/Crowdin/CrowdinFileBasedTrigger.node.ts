...
export class CrowdinFileBasedTrigger implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Crowdin (File-Based) Trigger',
		name: 'crowdinFileBasedTrigger',
		icon: { light: 'file:../../icons/crowdin.svg', dark: 'file:../../icons/crowdin.dark.svg' },
		group: ['trigger'],
		version: 1,
		subtitle: '={{$parameter["event"]}}',
		description: 'Starts the workflow when crowdin.com file-based project events occur',
		defaults: {
			name: 'Crowdin Trigger (File-Based)',
		},
		inputs: [],
