...
/**
 * Crowdin File-Based Task PATCH operation.
 */
export const tasksProperties: INodeProperties[] = [
	...
	},
	{
		...
		options: [
				...
				values: [
					{
						...
						options: [
							...
							},
							{
								...
								name: 'fileIds',
								type: 'multiOptions',
								typeOptions: { loadOptionsMethod: 'getProjectFilesMulti', loadOptionsDependsOn: ['projectId'] },
								default: [],
							...
							},
							{
								...
								options: [{ displayName: 'Items', name: 'items', values: [
									{ displayName: 'ID', name: 'id', type: 'options', typeOptions: { loadOptionsMethod: 'getProjectMembers', loadOptionsDependsOn: ['projectId'] }, default: '', description: 'User Identifier. Get via [List Project Members](#operation/api.projects.members.getMany)' },
			...
			{
				name: '_VendorPendingTaskOperation',
				displayName: 'Vendor Pending Task Operation',
				values: [
					{
						displayName: 'Fields',
						name: '_fields',
