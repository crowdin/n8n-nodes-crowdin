...
export const glossariesProperties: INodeProperties[] = [
	...
	},
	{
		...
		type: 'options',
		default: '',
		description: 'Group Identifier – defines group to which Glossary is added. Get via [List Groups](#operation/api.groups.getMany)\n *\n * If \'0\' – Glossary will be available for all projects and groups in your workspace',
		routing: {
			send: {
				property: 'groupId',
				propertyInDotNotation: false,
