...
export const styleGuidesProperties: INodeProperties[] = [
	...
	},
	{
		...
		type: 'options',
		default: '',
		description: 'Group Identifier - defines group to which Style Guide is added. If omitted, root group is used.',
		routing: {
			send: {
				property: 'groupId',
				propertyInDotNotation: false,
	...
	},
	{
		...
		type: 'boolean',
		default: false,
		description: 'Whether the style guide should be shared across all projects within the group',
		routing: {
			send: {
				property: 'isShared',
				propertyInDotNotation: false,
