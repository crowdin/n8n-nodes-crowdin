...
export const notificationsProperties: INodeProperties[] = [
	{
		...
		options: [
			{
				name: 'Send Notification To Organization Members',
				value: 'api.notify.post',
				action: 'Send Notification To Organization Members',
	...
	},
	{
		...
		options: [
			{
				displayName: 'For Authentificated User',
				name: '_forAuthentificatedUser',
				values: [
					{
						displayName: 'Message',
						name: 'message',
