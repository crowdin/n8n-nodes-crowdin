...
export const stringAssetCommentsProperties: INodeProperties[] = [
	...
	},
	{
		...
		options: [
			{
				displayName: 'Enterprise String Comment Create Form',
				name: '_enterpriseStringCommentCreateForm',
				values: [
					{
						displayName: 'String Id',
						name: 'stringId',
					...
					},
					{
						...
						type: 'boolean',
						default: false,
						description: 'Defines shared comment or issue',
						placeholder: 'true'
					},
					{
						displayName: 'Issue Type',
			...
			{
				displayName: 'Enterprise Asset Comment Create Form',
				name: '_enterpriseAssetCommentCreateForm',
				values: [
					{
						displayName: 'File Id',
						name: 'fileId',
