...
export const sourceFilesProperties: INodeProperties[] = [
	{
		...
		options: [
			...
			{
				name: 'List Reviewed Source Files Builds',
				value: 'api.projects.strings.reviewed-builds.getMany',
				action: 'List Reviewed Source Files Builds',
				description: '**Required scopes:** `project.source.string` (Read only).',
				routing: {
					request: {
						method: 'GET',
						url: '=/projects/{{$parameter["projectId"]}}/strings/reviewed-builds'
					},
					send: {
						paginate: '={{$parameter["returnAll"]}}'
					},
			...
			{
				name: 'Build Reviewed Source Files',
				value: 'api.projects.strings.reviewed-builds.post',
				action: 'Build Reviewed Source Files',
			...
			{
				name: 'Check Reviewed Source Files Build Status',
				value: 'api.projects.strings.reviewed-builds.get',
				action: 'Check Reviewed Source Files Build Status',
				description: '**Required scopes:** `project` (Read only).',
				routing: {
					request: {
						method: 'GET',
						url: '=/projects/{{$parameter["projectId"]}}/strings/reviewed-builds/{{$parameter["buildId"]}}'
					}
				}
			},
			{
				name: 'Download Reviewed Source Files',
				value: 'api.projects.strings.reviewed-builds.download.download',
				action: 'Download Reviewed Source Files',
				description: '**Required scopes:** `project` (Read only).',
				routing: {
					request: {
						method: 'GET',
						url: '=/projects/{{$parameter["projectId"]}}/strings/reviewed-builds/{{$parameter["buildId"]}}/download'
					}
				}
			}
		],
	...
	{
		displayName: 'GET /projects/{projectId}/strings/reviewed-builds',
		name: 'operation',
		type: 'notice',
		typeOptions: {
			theme: 'info'
		...
		displayOptions: {
			show: {
				...
				operation: [
					'api.projects.strings.reviewed-builds.getMany'
				]
			}
		}
	},
	{
		displayName: 'POST /projects/{projectId}/strings/reviewed-builds',
		name: 'operation',
		type: 'notice',
		typeOptions: {
			theme: 'info'
		...
		displayOptions: {
			show: {
				...
				operation: [
					'api.projects.strings.reviewed-builds.post'
				]
			}
		}
	},
	{
		displayName: 'GET /projects/{projectId}/strings/reviewed-builds/{buildId}',
		name: 'operation',
		type: 'notice',
		typeOptions: {
			theme: 'info'
	...
	{
		displayName: 'GET /projects/{projectId}/strings/reviewed-builds/{buildId}/download',
		name: 'operation',
		type: 'notice',
		typeOptions: {
			theme: 'info'
	...
	},
	{
		...
		name: 'buildId',
		required: true,
		description: 'Project Reviewed Source Files Build Identifier. Get via [List Reviewed Source Files Builds](#operation/api.projects.strings.reviewed-builds.getMany)',
		default: '',
		type: 'options',
		displayOptions: {
			show: {
		...
		typeOptions: {
			loadOptionsMethod: 'getProjectReviewedBuilds',
			loadOptionsDependsOn: [
				'projectId'
			]
		}
