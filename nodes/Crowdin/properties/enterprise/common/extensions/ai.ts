...
export const aiProperties: INodeProperties[] = [
	{
		...
		default: 'api.ai.settings.patch'
	},
	{
		displayName: 'PATCH /ai/settings',
		name: 'operation',
		type: 'notice',
		typeOptions: {
			theme: 'info'
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'options',
				default: '',
				description: 'AI Prompt ID to be used as prompt for AI Alignment action',
				typeOptions: {
					loadOptionsMethod: 'getAiPrompts'
				}
			},
