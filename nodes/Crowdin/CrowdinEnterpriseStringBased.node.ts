...
import { properties } from './properties/enterprise/stringBased';
...
import { extensions as variantExtensions } from './properties/enterprise/common/extensions/stringBased';

extendProperties(properties, [...commonExtensions, ...platformExtensions, ...variantExtensions]);

export class CrowdinEnterpriseStringBased implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Crowdin Enterprise (String-Based)',
		name: 'crowdinEnterpriseStringBased',
