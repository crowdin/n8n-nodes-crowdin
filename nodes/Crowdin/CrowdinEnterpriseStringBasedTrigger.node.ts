...
export class CrowdinEnterpriseStringBasedTrigger implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Crowdin Enterprise (String-Based) Trigger',
		name: 'crowdinEnterpriseStringBasedTrigger',
		icon: { light: 'file:../../icons/crowdin.svg', dark: 'file:../../icons/crowdin.dark.svg' },
		group: ['trigger'],
		version: 1,
		subtitle: '={{$parameter["event"]}}',
		description: 'Starts the workflow when Crowdin Enterprise string-based project events occur',
		defaults: {
			name: 'Crowdin Enterprise Trigger (String-Based)',
		},
		inputs: [],
