...
export const PROJECT_EVENTS: WebhookEvent[] = [
	{
		name: 'File Added',
		value: 'file.added',
		description: 'Project file is added',
	},
	{
		name: 'File Updated',
		value: 'file.updated',
		description: 'Project file is updated',
	},
	{
		name: 'File Reverted',
		value: 'file.reverted',
		description: 'Project file is reverted',
	},
	{
		name: 'File Deleted',
		value: 'file.deleted',
		description: 'Project file is deleted',
	},
	{
		name: 'File Translated',
		value: 'file.translated',
		description: 'Project file is fully translated',
	},
	{
		name: 'File Approved',
		value: 'file.approved',
		description: 'Project file is fully reviewed',
	},
	{
		name: 'File Qa Finished',
		value: 'file.qa.finished',
		description: 'Project file QA check is finished',
	},
	{
	...
	},
	{
		...
		description: 'All strings in project are QA check is finished',
	},
	{
		name: 'Project Built',
		value: 'project.built',
